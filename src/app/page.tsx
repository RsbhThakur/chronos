...
import { ArrowDown, Clock, Shield, Sparkles, Zap, Calendar, Mic, RefreshCw, Users, Heart } from 'lucide-react';
...
export default function Home() {
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-primary)', color: 'var(--text-primary)', overflowX: 'hidden' }}>
      ...
      {/* 1. HERO SECTION */}
      <header style={{ position: 'relative', height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center', padding: '0 24px' }}>
        ...
        <div className="glass-card" style={{ padding: '64px var(--space-8)', maxWidth: '850px', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '24px', zIndex: 10 }}>
          <h1 className="hero-title neon-text-cyan">
            CHRONOS
          </h1>
          
          <h2 style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-xl)', fontWeight: 600, letterSpacing: '3px', color: 'var(--neon-purple)', textTransform: 'uppercase' }}>
            Your AI Time Guardian
          </h2>
          
          <p style={{ color: 'var(--text-secondary)', fontSize: 'var(--text-lg)', maxWidth: '600px', lineHeight: '1.6', margin: '8px 0 16px' }}>
            Don't just manage time. Rescue it.
          </p>

          <div className="cta-container" style={{ display: 'flex', gap: '20px', width: '100%', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/login" className="glow-button glow-button--solid" style={{ minWidth: '180px', textDecoration: 'none' }}>
              <Zap size={16} /> Start Free
            </Link>
            <Link href="/login" className="glow-button" style={{ minWidth: '180px', textDecoration: 'none' }}>
              <Clock size={16} /> Try Demo
            </Link>
          </div>
        </div>
        ...
        <div style={{ position: 'absolute', bottom: '40px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', zIndex: 10, opacity: 0.8 }}>
          ...
          <ArrowDown size={20} className="neon-text-cyan" style={{ animation: 'scroll-bounce 2s infinite ease-in-out' }} />
        </div>
      </header>
